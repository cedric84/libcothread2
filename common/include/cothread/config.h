...
#define COTHREAD_ARCH_ID_AARCH64	3	///< @brief	The AArch64 architecture identifier.
...
/// @}
	...
	#define	COTHREAD_ARCH_ID	COTHREAD_ARCH_ID_X86_64
#elif	((COTHREAD_CC_ID_CLANG == COTHREAD_CC_ID) && defined(__aarch64__))
	#define	COTHREAD_ARCH_ID	COTHREAD_ARCH_ID_AARCH64
...
#elif	(!0	\
		&& (COTHREAD_CC_ID_CLANG		== COTHREAD_CC_ID)		\
		&& (COTHREAD_ARCH_ID_AARCH64	== COTHREAD_ARCH_ID)	\
		&& (COTHREAD_OS_ID_MACOS		== COTHREAD_OS_ID)		\
		)
	#define COTHREAD_LINK_EXPORT
	#define	COTHREAD_LINK_HIDDEN	__attribute__ ((visibility ("hidden")))
